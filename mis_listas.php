    ...
    if(isset($_SESSION['admin']) or isset($_SESSION['usuario']))
    {
        ...
        {
            ?>
            <div class="modal fade modal_instrucciones" id="modal_instrucciones" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <span class="font-weight-bold" style="font-size: 23px;">Para poder cotizar una lista escoge una de las siguientes opciones</span>
                            <br>
                            <p class="mt-3"><span class="font-weight-bold" style="font-size: 17px;">Crear tu propia lista:</span> Aquí deberás ponerle nombre a tu lista para luego comenzar a agregar uno por uno los productos que necesitas.</p>
                            <p><span class="font-weight-bold" style="font-size: 17px;">Ocupar una lista plantilla:</span> Con esta opción puedes ahorrar mucho tiempo. Debes ir a "Listas plantillas", buscar la lista del establecimiento y curso que necesites y apretar en "ocupar" (puedes revisar la lista antes).
                            Después de esto se creará una copia de la plantilla para ti (estará ubicada en "Ver mis listas") la cual podrás cambiar o eliminar los productos que desees.</p>

                            <p>Luego que has terminado tu lista debes presionar "Quiero esta lista" (el botón que se encuentra bajo el total dentro de tu lista) y se desplegará una ventana donde deberás llenar unos datos, y presionar "Enviar cotización". Luego de esto nos contactaremos contigo para coordinar la entrega.
                        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            $consulta = "Select nombreLista, idLista, date_format(fecha,'%d-%m-%Y') as fecha, nombreInteresado from lista where correoUsuario = '$correo' and estado= 'Creada'";
            ...
            if($filas<1)
            {
                ...
                <div class="col col-sm-12 col-md-3 text-center mb-3 border border-warning" style="width: 18rem; height: auto; background-color: rgba(0,0,0,.40);">
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-bold mt-1 text-white" style="font-size: 25px;">Más por hacer</p>
                            </div>
                    </div> 
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-normal mt-1 text-white" style="font-size: 18px;">No tienes listas. Para crear una</p>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-12 text-center">
                            <a href="crear_lista.php"><button type="submit"  class="btn btn-warning text-white border border-white" onclick="">Click aquí</button></a></p>
                            </div>
                    </div>
                    <hr>
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-normal mt-1 text-white" style="font-size: 18px;" onclick="">Ver listas ya cotizadas</p>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-12 text-center">
                            <a href="ver_listas_cotizadas.php"><button type="submit" class="btn btn-warning text-white border border-white" onclick="">Click aquí</button></a></p>
                            </div>
                    </div>
                    <hr>
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-normal mt-1 text-white" style="font-size: 18px;" onclick="">Listas plantillas</p>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-12 text-center">
                            <a href="ver_listas_plantillas.php"><button type="submit" class="btn btn-warning text-white border border-white" onclick="">Click aquí</button></a></p>
                            </div>
                    </div>
                ...
                <div class="col-md-9 text-center">
                    <p class ="mt-4 text-muted font-weight-bold" style="font-size: 25px;">No tienes listas. Elige algunas de las opciones del recuadro izquierdo</p>
                    <img src="img/Flecha izquierda.jpg" style="height: 50px; width: 80px;" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|} mt-4" alt="">
                </div>
                <div class="row">
                    <div class="col-md-12">
            ...
            else
            {
                ...
                <div class="col col-sm-12 col-md-3 col-lg-3 text-center mb-3 border border-warning" style="width: 18rem; height: 500px; background-color: rgba(0,0,0,.40);">
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-bold mt-1 text-white" style="font-size: 25px;">Más por hacer</p>
                            </div>
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-normal mt-1 text-white" style="font-size: 18px;">¿Deseas crear una nueva lista?</p>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-12 text-center">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <p class="font-weight-normal mt-1 text-white" style="font-size: 18px;">Ver listas ya cotizadas</p>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-12 text-center">
                ...
                while($fila = mysqli_fetch_array($resultado))
                {
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 mb-3"  >
                        <div class="card-deck">
                            <div class="card h-50 border border-warning" style="width: 20rem; height: 10rem;">
                                <div class="row">
                                    ...
                                    <div class="col col-sm-2 col-lg-2">
                                        <div class="row">
                                            <div class="col col-sm-6 col-lg-6 float-right">
                                                <button type="button" class="btnEditarLista close" name ="btnEditarLista" id="<?php echo $idLista; ?>" onclick="editar_lista(<?php echo $idLista; ?>)">
                                                    <i class="far fa-edit" style="font-size: 15px;"></i>
                                                </button>
                                            </div>
                                            <div class="col col-sm-6 col-lg-6 float-left">
                                                <button type="button" class="close mr-1" aria-label="Close" onclick="eliminar_lista(<?php echo $idLista; ?>)">
                                    ...
                                    <div class="card-body" style="">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <small class="font-weight-bold text-muted">Codigo de lista: </small><small class="text-muted"><?php echo $idLista ?></small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <small class="font-weight-bold text-muted">Fecha de creación: </small><small class="text-muted"><?php echo $fecha; ?></small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <small class="font-weight-bold text-muted">Creada por: </small><small class="text-muted"><?php echo $nombreInteresado; ?></small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer"> 
                                        <div class="row">
                                            <form class="col-md-7" method="POST" id="formMisListas" action="consulta_producto_its.php">
                                                <input type="text" hidden value="<?php echo $idLista; ?>" name="idLista" id="<?php echo $idLista; ?>">
                                                <input type="text" hidden value="<?php echo $nombreLista; ?>" name="nombreLista" id="<?php echo $nombreLista; ?>">
                                                <input type="submit" value="Agregar producto" name="btnAgregar" id="<?php echo $idLista; ?>" style="font-size: 14px;" class="btn btn-warning text-white mx-auto d-block"/>
                                            </form>
                                            
                                            <form class="col-md-5" method="POST" id="formMisListas" action="ver_lista_usuario.php">
                                                <input type="text" hidden value="<?php echo $idLista; ?>" name="idLista" id="<?php echo $idLista; ?>">
                                                <input type="text" hidden value="<?php echo $nombreLista; ?>" name="nombreLista" id="<?php echo $nombreLista; ?>">
                                                <input type="submit" name="btnVerLista" value="Ver lista" style="font-size: 14px;" id="<?php echo $idLista; ?>" class="btn btn-warning text-white mx-auto d-block"/>
                                            </form>
    ...
    <div class="modal modal_editar_lista" id="editar_view" tabindex="-1" id="<?php $idLista; ?>" role="dialog">
        <div class="modal-dialog" role="document">
...
<!-- Footer -->
    <?php
        ...
        var btnEditarLista = document.getElementsByName('btnEditarLista');                                        
        });

        function editar_lista(idLista)
        {
            var id = idLista;
            $.ajax({  
            url:"modal_editar_lista.php",  
            method:"post",  
            data:{id:id},  
                success:function(data)
                {  
                    $('#contenido').html(data);  
                    $('#editar_view').modal("show");
                }  
            }); 
        } 
