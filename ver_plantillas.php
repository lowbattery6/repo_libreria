...
<body style="background-color : #f5f5f5">
    ...
    <div class="contiene">
<div name="Titulo" class="text-center"><h1>Plantillas</h1></div>

<div name="TablaListas">
    <?php
    
    $consulta="select nombreLista, nombreInteresado, tipoLista, idLista from lista where estado = 'Plantilla'";
