                    ...
                    <br>
                                            ...
                                            while($fila2=mysqli_fetch_array($resultado2))
                                            {
                                                ...
                                                <div class="row mt-3"><!-- Comienza div row de las cartas -->
                                                    ...
                                                    <form class="col-md-3" method="post" action="cambiar_producto.php?idProducto1=<?php echo $idProducto1; ?>&idProducto2=<?php echo $idProducto2; ?>&idLista=<?php echo $idLista; ?>&precioContiene=<?php echo $precioFinal; ?>"><!-- Comienza div col de acciones -->
                                                        <div class="row ">
                                                        <div class="col-sm-8 md-6">
                                                        <input type="text" value="<?php echo $nombreLista; ?>" hidden name="txtNombreLista" id="txtNombreLista">
