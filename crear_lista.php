...
if(isset($_SESSION['admin']) or isset($_SESSION['usuario']))
{
    ...
    $consulta="select nombre, apellidoPaterno from usuario where correo = '$correo'";
...
<body style="background-image:url('img/PapeleriaTrue.jpg'); background-size: cover;">
    ...
    <div class="row bg-light container-fluid" style="height: auto; width: auto;">
                            ...
                            <div class="text-center" style="height: 150px; display: flex; flex-direction: column; justify-content: center; text-align: center; background: transparent;">      
                                        ...
                                        <div style="background: rgba(0,0,0,.40); width: auto;">
                                            <p class="display-3 text-light"><b>Crear Lista</b></p>
                                        </div>
    ...
    <div class="container">
            <form id="form1" name="form1" method="post" action="creando_lista.php">
                <div class="container mt-5 mb-5 border border-warning" style="height: auto; width: 300px; border:solid;">
                    <div class="row">
                        <div class="col-md-12 bg-light">
                            <h3 class="text-center mt-4">Crear Lista</h3>
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <h5>Ingrese nombre de la lista</h5>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="txtNombreLista" name="txtNombreLista" size="20" placeholder="Nombre de lista">
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-md-12">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="txtNombreInteresado" name="txtNombreInteresado"size="20" value="<?php echo $nombre;?> <?php echo $apellidoPaterno ?>">
                                </div>
                            </div>
                            <div class="row text-center mt-4 mb-4">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-warning" style="color: white; borded-color: white;">Crear Lista</button>
                                </div>
                            </div>
                        </div> 
                        </div>
