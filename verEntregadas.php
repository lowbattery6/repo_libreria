...
<body style="background-color : #f5f5f5">
    ...
    <div class="contiene">
<title>Listas</title>
<div align="center" name="Titulo"><h1>Listas Entregadas</h1></div>

<div name="TablaListas" align="center">
    <?php
    
    $consulta="select nombreLista, nombreInteresado, tipoLista, idLista from lista where estado = 'Entregada'";
