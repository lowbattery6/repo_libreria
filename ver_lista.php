...
<body style="background-color : #f5f5f5">
    ...
    <header class="HeaderListas">
            ...
            <span>Volver al menú</span>
             ...
             <a href="ver_plantillas.php" class="volverMenuListas">
            <span>Ver plantillas</span>
             </a>
             <a href="ver_cotizadas_clientes.php" class="volverMenuListas">
            <span>Cotizadas por clientes</span>
             </a>
    ...
    <div class="contiene">
<div align="center" name="Titulo"><h1>Listas</h1></div>

<div name="TablaListas" align="center">
    <?php
    
    $consulta="select nombreLista, nombreInteresado, tipoLista, idLista from lista where estado = 'Creada'";
